...
async function openPayrollDetail(token) {
    ...
    try {
        ...
        document.getElementById('bordroSheetBody').innerHTML = `<div class="space-y-3">
            ...
            <section class="grid grid-cols-2 gap-2">
                ${s.banka ? `<div class="rounded-xl border border-blue-100 bg-blue-50 p-3 dark:border-blue-900/30 dark:bg-blue-900/15"><span class="material-symbols-outlined text-lg text-blue-500">account_balance</span><span class="mt-1 block text-[9px] font-black uppercase text-blue-400">Banka</span><b class="text-sm text-blue-700 dark:text-blue-300">${s.banka}</b></div>` : ''}
