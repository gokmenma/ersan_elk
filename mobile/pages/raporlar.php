...
// Raporlar modülünün veritabanındaki ID'si 61'dir ve auth_name kolonu boştur. 
// Bu yüzden yetki kontrolünü ID 61 üzerinden de güvenceye alıyoruz.
...
if (!$hasReportPermission && !Gate::allows("puantaj_raporlama") && !Gate::allows("puantaj_yonetim") && !Gate::allows("puantaj/raporlar")) {
