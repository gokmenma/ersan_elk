...
!(function (e, t) {
  ...
  class c {
    ...
    init() {
      ...
      // URL'den p parametresini al
      const urlParams = new URLSearchParams(window.location.search);
      const currentPage = urlParams.get("p");


      if (currentPage) {
        // p parametresine göre menü öğesini bul
        i.find("a").each(function () {
          let active_page = n.default(this).attr("data-active");
          //console.log(active_page);
          if ((active_page && currentPage.startsWith(active_page)) || this.href.includes(currentPage)) {
            const menuItem = n.default(this).parent(t.parentTrigger);
            menuItem.addClass(g);
            menuItem.parents(t.parentTrigger).addClass(g);
            menuItem.parents(t.subMenu).addClass(`${u} ${h}`);
          }
        });
      }
    }
