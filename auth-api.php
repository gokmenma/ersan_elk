...
if ($action === 'forgot-password') {
    ...
    if (!$user) {
        // Güvenlik gereği "kullanıcı bulunamadı" yerine "işlem yapıldı" denebilir ama burada daha spesifik olalım eğer istenirse.
        // Ancak bu sistemde genellikle kullanıcıya bilgi verilir.
    ...
    if ($User->setResetToken($user->id, $token)) {
        ...
        try {
            MailGonderService::gonder([$user->email_adresi], $konu, $icerik, [], [], [], null, (int)$user->owner_id);
