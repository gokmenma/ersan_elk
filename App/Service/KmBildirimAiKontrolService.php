...
class KmBildirimAiKontrolService
{
    ...
    private function adjudicateCloseOdometerReading(array $image, array $analiz, object $bildirim): array
    {
        ...
        $prompt = sprintf(
            ...
            . 'Camdaki ağaç veya gökyüzü yansıması rakamların biçimini hâlâ seçilebilir bırakıyorsa sırf yansıma nedeniyle adayı reddetme. '
        ...
        $adayKesin = !empty($hakem['candidate_exact']) && (int) ($hakem['confidence'] ?? 0) >= 90;
        error_log(sprintf(
