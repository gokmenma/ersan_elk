...
class EndeskOkumaService
{
    ...
    public function __construct()
    {
        ...
        $this->apiKey = $all['api_endeks_sifre'] ?? 'sk_live_DSOSTjHN195B4NUpEaB9NdYtW7xQ8EVjZD2p2ssW';
        $this->apiUrl = $all['api_endeks_url'] ?? 'https://yonetim.maraskaski.gov.tr/api/api_okuma_secure.php?action=getData';
    }

    /**
     * API'den okuma verilerini getirir.
     * 
