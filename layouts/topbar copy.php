         ...
         <div class="d-flex">
             ...
             <div class="navbar-brand-box">
                 <a href="index.php" class="logo logo-dark">
                     ...
                     <span class="logo-lg">
                         <img src="../assets/images/logo/logo.svg" alt="" height="24"> <span class="logo-txt">Cansen</span>
                     </span>
                 </a>

                 <a href="index.php" class="logo logo-light">
                     <span class="logo-sm">
                         <img src="../assets/images/logo/logo.svg" alt="" height="30">
                     </span>
                     <span class="logo-lg">
                         <img src="../assets/images/logo/logo.svg" alt="" height="36"><span class="logo-txt">Cansen
                         </span>
                     </span>
                 </a>
             </div>
         ...
         <div class="d-flex">
             ...
             <div class="dropdown d-inline-block">
                 <button type="button" class="btn header-item bg-light-subtle border-start border-end" id="page-header-user-dropdown" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                     ...
                     <span class="d-none d-xl-inline-block ms-1 fw-medium setting_user_name" id="setting_user_name"><?php echo $_SESSION["user_full_name"]; ?></span>
