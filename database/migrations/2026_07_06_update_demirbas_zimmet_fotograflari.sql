DROP TABLE IF EXISTS `demirbas_zimmet_fotograflari`;

CREATE TABLE `demirbas_zimmet_fotograflari` (
    ...
    KEY `idx_hareket` (`hareket_id`),
    KEY `idx_firma` (`firma_id`),
    CONSTRAINT `fk_demirbas_zimmet_foto_zimmet` FOREIGN KEY (`zimmet_id`) REFERENCES `demirbas_zimmet` (`id`) ON DELETE CASCADE,
    CONSTRAINT `fk_demirbas_zimmet_foto_hareket` FOREIGN KEY (`hareket_id`) REFERENCES `demirbas_hareketler` (`id`) ON DELETE CASCADE
