...
CREATE TABLE `demirbas_servis_kayitlari` (
  ...
  `tutar` decimal(10,2) DEFAULT 0.00,
  `fatura_no` varchar(100) DEFAULT NULL,
  `fatura_dosya_adi` varchar(255) DEFAULT NULL,
  `fatura_orijinal_adi` varchar(255) DEFAULT NULL,
  `fatura_mime_tipi` varchar(100) DEFAULT NULL,
  `fatura_boyutu` int(11) DEFAULT NULL,
  `olusturan_kullanici_id` int(11) DEFAULT NULL,
  `olusturma_tarihi` datetime DEFAULT current_timestamp(),
  `guncelleme_tarihi` datetime DEFAULT current_timestamp() ON UPDATE current_timestamp(),
  `silinme_tarihi` datetime DEFAULT NULL,
...
CREATE TABLE `personel` (
  ...
  `calisilan_firma` varchar(150) DEFAULT NULL,
  `calisilan_proje` varchar(150) DEFAULT NULL,
