            ...
            <div class="modal-content">
                ...
                <form id="formPersonelKesintiEkle" novalidate>
                    ...
                    <div class="modal-body">
                        ...
                        <div class="mb-3">
                            <label class="form-label fw-semibold">Kesinti Türü <span
                        ...
                        <div class="mb-3">
                            ...
                            <div class="d-flex gap-3">
                                <div class="form-check form-check-primary">
                                    <input class="form-check-input" type="radio" name="tekrar_tipi"
                                        id="tekrar_tek_sefer" value="tek_sefer" checked>
                            ...
                            <div class="d-flex gap-3">
                                <div class="form-check">
                                    <input class="form-check-input" type="radio" name="hesaplama_tipi"
                                        id="hesaplama_sabit" value="sabit" checked>
                        ...
                        <div class="mb-3 d-none" id="div_icra_secimi">
                            <div class="form-floating form-floating-custom">
                                <select class="form-select select2" id="kesinti_icra_id" name="icra_id"
                                    style="width: 100%">
