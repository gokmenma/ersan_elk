        ...
        min-width: 600px;
                ...
                <div class="card-body overflow-auto">
                    ...
                    <table id="membersTable"
                        class="table table-selected table-responsive dt-responsive table-bordered nowrap w-100">
                        <thead>
                            <tr>
                                ...
                                <div class="tab-pane" id="tabCalisma" role="tabpanel">
                                    <div class="row">
                                        ...
                                        <div class="col-md-6 mb-3">
                                            ...
                                            <div id="detailProje" class="fw-bold text-dark border-bottom pb-1"></div>
                                        </div>
                                        <div class="col-md-6 mb-3">
                                            <label class="form-label text-muted font-size-13">Takım</label>
                                            <div id="detailTakim" class="fw-bold text-dark border-bottom pb-1"></div>
                                        </div>
                                        <div class="col-md-6 mb-3">
                                            <label class="form-label text-muted font-size-13">SGK No</label>
                                            <div id="detailSgkNo" class="fw-bold text-dark border-bottom pb-1"></div>
                                        </div>
                                        <div class="col-md-6 mb-3">
