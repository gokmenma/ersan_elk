    ...
    switch ($action) {
        ...
        case 'save_icra':
            $data = [
                ...
                'alacakli' => trim((string) ($_POST['icra_alacakli'] ?? '')) ?: null,
                'iban' => $_POST['icra_iban'] ?? null,
                'hesap_bilgileri' => $_POST['icra_hesap_bilgileri'] ?? null,
                'toplam_borc' => \App\Helper\Helper::formattedMoneyToNumber($_POST['icra_toplam_borc'] ?? 0),
                'aylik_kesinti_tutari' => \App\Helper\Helper::formattedMoneyToNumber($_POST['icra_aylik_kesinti'] ?? 0),
                'kesinti_tipi' => $_POST['icra_kesinti_tipi'] ?? 'tutar',
                'kesinti_orani' => \App\Helper\Helper::formattedMoneyToNumber($_POST['icra_kesinti_orani'] ?? 0),
