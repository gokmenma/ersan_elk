                ...
                <div class="card-body">
                    <div class="tab-content" id="demirbasTabContent">
                        ...
                        <div class="tab-pane fade show active" id="demirbasContent" role="tabpanel">
                            <div class="table-responsive">
                                <table id="demirbasTable"
                                    class="table datatable table-hover table-bordered nowrap w-100">
                                        ...
                                        <?php if (empty($demirbaslar)): ?>
                                            <tr>
                                                <td colspan="9" class="text-center text-muted py-4">
                                                    ...
                                                    Henüz demirbaş eklenmemiş.<br>
                                                    <small>"Yeni Demirbaş" butonuna tıklayarak ekleyebilirsiniz.</small>
                                                </td>
                                            </tr>
                                        <?php else: ?>
                                            <?php
                        ...
                        <div class="tab-pane fade" id="zimmetContent" role="tabpanel">
                            <div class="table-responsive">
                                <table id="zimmetTable" class="table datatable table-hover table-bordered nowrap w-100">
                                    <thead class="table-light">
                                        <tr>
