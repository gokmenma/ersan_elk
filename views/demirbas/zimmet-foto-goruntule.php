...
$FotoModel = new DemirbasZimmetFotoModel();
...
$sifreliYol = dirname(__DIR__, 2) . '/files/demirbas_zimmet_foto/' . $foto->zimmet_id . '/' . $foto->dosya_adi;
...
try {
    ...
    error_log('Demirbaş zimmet fotoğrafı çözülemedi: ' . $e->getMessage());
    http_response_code(500);
    exit('Görsel görüntülenemedi.');
}

$SystemLog = new SystemLogModel();
$SystemLog->logAction($_SESSION['user_id'] ?? 0, 'Demirbaş Zimmet Fotoğraf Görüntüleme', "Zimmet (#{$foto->zimmet_id}) için bir {$foto->foto_turu} fotoğrafı görüntülendi.", SystemLogModel::LEVEL_INFO);
