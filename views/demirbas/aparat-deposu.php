...
// ====== APARAT KATEGORİ ID'LERİ ======
$sayacKatIds = [];
$tumKategoriler = $Tanimlamalar->getDemirbasKategorileri();
foreach ($tumKategoriler as $kat) {
    if (str_contains(mb_strtolower($kat->tur_adi, 'UTF-8'), 'aparat') || $kat->id == 645) {
    ...
    <div class="card">
            ...
            <ul class="nav nav-tabs nav-tabs-custom nav-justified" role="tablist">
                <li class="nav-item">
                    <a class="nav-link active fw-bold" data-bs-toggle="tab" href="#personel-tab" role="tab">
                        <span class="d-none d-sm-block"><i class="bx bx-wrench me-1"></i> Personel Bazlı Aparat Durumu</span>
                    </a>
                </li>
                <li class="nav-item">
                    <a class="nav-link fw-bold" data-bs-toggle="tab" href="#aparatlar-tab" role="tab">
                        <span class="d-none d-sm-block"><i class="bx bx-package me-1"></i> Aparat Listesi</span>
                    </a>
                </li>
            </ul>
        </div>
        ...
        <div class="card-body">
            <div class="tab-content text-muted">
                ...
                <div class="tab-pane active" id="personel-tab" role="tabpanel">
                    <div class="d-flex justify-content-between align-items-center mb-3">
                        <h5 class="mb-0 fw-bold" style="color: #495057;">
                            <i class="bx bx-wrench me-1"></i> Personel Bazlı Aparat Durumu
                        </h5>
                        <div>
                            <button type="button" class="btn btn-warning btn-sm fw-bold shadow-sm" id="btnPersonelAta">
                                <i class="bx bx-user-plus me-1"></i> Personele Aparat Ver
                            </button>
                        </div>
                    </div>
                        ...
                        <table id="sayacPersonelTable" class="table table-hover table-bordered align-middle nowrap w-100">
                            <thead class="table-light">
                                <tr>
                                    ...
                                    <th class="text-center">Tüketilen / İade</th>
                ...
                <!-- APARATLAR TAB -->
                <div class="tab-pane" id="aparatlar-tab" role="tabpanel">
                    <div class="d-flex justify-content-between align-items-center mb-3">
                        <h5 class="mb-0 fw-bold" style="color: #495057;">
                            <i class="bx bx-package me-1"></i> Tüm Aparatların Detaylı Listesi
                        </h5>
                        <div class="d-flex gap-2">
                            <button type="button" class="btn btn-primary btn-sm fw-bold shadow-sm" id="btnYeniAparat" data-bs-toggle="modal" data-bs-target="#demirbasModal">
                                <i class="bx bx-plus me-1"></i> Yeni Aparat Ekle
                            </button>
                            <button type="button" class="btn btn-warning btn-sm fw-bold shadow-sm" id="btnAparatPersoneleVer">
                                <i class="bx bx-transfer me-1"></i> Personele Ver
                            </button>
                        </div>
                    </div>
                    <div class="table-responsive">
                        <table id="aparatTable" class="table table-bordered table-hover dt-responsive nowrap w-100 align-middle">
                            <thead class="table-light">
                                <tr>
                                    <th style="width: 20px;" class="align-middle text-center">
                                        <div class="custom-checkbox-container">
                                            <input type="checkbox" class="custom-checkbox-input" id="checkAllAparat">
        ...
        <div class="modal-content border-0 shadow-lg" style="border-radius: 12px;">
            <div class="modal-header bg-soft-info border-bottom">
                <div class="d-flex align-items-center">
                    ...
                    <div>
                        <h6 class="modal-title text-info mb-0 fw-bold">Personel Aparat Hareketleri</h6>
...
<script>
    var aparatKatIds = <?= json_encode($sayacKatIds) ?>;
</script>
<script src="views/demirbas/js/demirbas.js?v=<?= time() ?>"></script>
<script src="views/demirbas/js/aparat-deposu.js?v=<?= time() ?>"></script>
