...
<div class="container-fluid">
    ...
    <style>
        ...
        #bordroTable thead th {
            ...
            /* İçeriğin üstüne bindiğinde arkası görünmesin */
            box-shadow: inset 0 -1px 0 #eff2f7, inset 0 1px 0 #eff2f7 !important;
            /* Alt/Üst sınırları koru */
        }
        ...
        .floating-thead th {
            ...
            /* Normalden biraz daha koyu/farklı bir gri-mavi */
                                    ...
                                    <div class="d-none d-md-flex align-items-center gap-3">
                                        ...
                                        <div class="d-flex align-items-start gap-2">
                                            ...
                                            <?php if (!empty($gorevGecmisiEksikPersoneller)): ?>
                                                    <span class="badge shadow-sm border rounded-pill px-3 py-2 fw-bold d-flex align-items-center"
