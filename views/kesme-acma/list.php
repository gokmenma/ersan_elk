...
<style>
    ...
    .ka-dashboard-bar{margin-bottom:10px}.ka-dashboard-metrikler .card{border:1px solid var(--bs-border-color)!important}.ka-analiz-metrik .card-body{padding:12px 14px}.ka-analiz-metrik strong{display:block;margin-top:7px;font-size:1.35rem;font-variant-numeric:tabular-nums}.ka-metrik-alt{font-size:.68rem;margin-top:2px;white-space:nowrap;overflow:hidden;text-overflow:ellipsis}.ka-dashboard-kolonlar>.col-xl-8>.card,.ka-dashboard-kolonlar>.col-xl-4>.card{border:1px solid var(--bs-border-color)!important}.ka-dashboard-kolonlar .card-header{padding:13px 16px;border-bottom:1px solid var(--bs-border-color)}.ka-dashboard-kolonlar .card-header h5{font-size:.9rem}.ka-dashboard-kolonlar .card-header p{font-size:.7rem!important;margin-top:3px}.ka-dashboard-kolonlar table th{font-size:.68rem;white-space:nowrap}.ka-dashboard-kolonlar table td{font-size:.75rem}.ka-personel-karsilastirma th[data-sort]{cursor:pointer;user-select:none}.ka-personel-karsilastirma th[data-sort]:hover{color:var(--bs-primary)}.ka-personel-karsilastirma th.sirali:after{margin-left:5px;color:var(--bs-primary);font-size:.65rem}.ka-personel-karsilastirma th.azalan:after{content:'▼'}.ka-personel-karsilastirma th.artan:after{content:'▲'}.ka-personel-karsilastirma td:first-child small{font-size:.63rem;font-weight:400;margin-top:2px}
    .ka-analiz-grafik{min-height:220px;overflow-x:auto}.ka-analiz-grafik svg{min-width:650px}.ka-analiz-sutun{cursor:crosshair;transition:opacity .12s,filter .12s}.ka-analiz-sutun:hover{opacity:.82;filter:brightness(1.08)}.ka-grafik-ipucu{position:fixed;z-index:1090;display:none;min-width:118px;padding:8px 10px;border-radius:7px;background:#171923;color:#fff;box-shadow:0 6px 20px rgba(0,0,0,.28);pointer-events:none;font-size:.72rem}.ka-grafik-ipucu.goster{display:block}.ka-grafik-ipucu b,.ka-grafik-ipucu span{display:block}.ka-grafik-ipucu span{margin-top:2px;color:#d5d9e2;font-size:.69rem}
        ...
        <div class="tab-pane fade show active" id="pane-ka-dashboard">
            ...
            <div class="row g-3 mt-0 ka-dashboard-kolonlar">
                <div class="col-xl-8 d-flex flex-column gap-3">
                    ...
                    <div class="card border-0 shadow-sm"><div class="card-header bg-transparent d-flex flex-wrap align-items-center gap-2"><div><h5 class="mb-0 fw-bold text-dark">Personel karşılaştırması</h5><p class="small text-muted mb-0">Başlığa tıklayarak büyükten küçüğe veya küçükten büyüğe sıralayın.</p></div><div class="btn-group btn-group-sm ms-lg-auto" id="kaPersonelGrup"><button type="button" class="btn btn-primary" data-grup="saha">Saha personeli</button><button type="button" class="btn btn-outline-primary" data-grup="ofis">Ofis / toplu giriş</button><button type="button" class="btn btn-outline-primary" data-grup="hepsi">Hepsi</button></div></div><div class="table-responsive"><table class="table table-sm table-hover mb-0 ka-personel-karsilastirma"><thead class="table-light"><tr><th data-sort="personel">Personel</th><th class="text-end" data-sort="gun">Gün</th><th class="text-end" data-sort="toplam">Toplam</th><th class="text-end" data-sort="olumlu">Olumlu</th><th class="text-end" data-sort="gunluk_ortalama">G. Ort.</th><th class="text-end" data-sort="delta_toplam">Δ Toplam</th><th class="text-end" data-sort="delta_ortalama">Δ G. Ort.</th><th class="text-end" data-sort="odeme">Ödeme</th><th class="text-end" data-sort="odeme_sapma">Ödeme Sapma</th><th class="text-end" data-sort="kapali">Kapalı</th><th class="text-end" data-sort="kapali_sapma">Kapalı Sapma</th><th class="text-end" data-sort="sonuc_orani">Sonuç %</th></tr></thead><tbody id="kaAnalizPersonel"></tbody></table></div></div>
