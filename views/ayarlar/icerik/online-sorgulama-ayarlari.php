...
<form action="" id="onlineSorgulamaAyarlariForm">
    ...
    <div class="card shadow-sm mb-4">
        <div class="card-header bg-light">
            <h5 class="mb-0 text-primary"><i data-feather="settings" class="me-2"></i>Online Sorgulama Genel Ayarları</h5>
        </div>
            ...
            <div class="row mb-3">
                <div class="col-md-12">
                    <div class="form-check form-switch form-switch-lg">
                        ...
                        <label class="form-check-label" for="online_sorgulama_aktif">Otomatik Online Sorgulama Aktif</label>
                    </div>
                    <div class="form-text ps-1">Bu ayar aktifken, belirlenen saatlerde otomatik olarak online sorgulama yapılır.</div>
                </div>
            </div>
    ...
    <div class="card shadow-sm mb-4">
        <div class="card-header bg-light">
            <h5 class="mb-0 text-primary"><i data-feather="activity" class="me-2"></i>Endeks Okuma Sorgulama Zamanlaması</h5>
        </div>
        <div class="card-body p-4">
            <div class="row">
                <div class="col-md-6 mb-3">
    ...
    <div class="card shadow-sm mb-4">
        <div class="card-header bg-light">
            <h5 class="mb-0 text-primary"><i data-feather="scissors" class="me-2"></i>Kesme/Açma İşlemleri Sorgulama Zamanlaması</h5>
        </div>
        <div class="card-body p-4">
            <div class="row">
                <div class="col-md-6 mb-3">
        ...
        <div class="card-body p-4">
            ...
            <div class="row">
                <div class="col-md-12 mb-3">
                    ...
                    <div class="form-text">Örn: http://10.185.0.52:9090/webBase/faces/jsfPage/report/gelir/su/Isemri...</div>
                </div>
            </div>
            <div class="row">
                <div class="col-md-6 mb-3">
