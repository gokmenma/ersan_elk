                    ...
                    <div class="card-header">
                        <div class="d-flex flex-wrap align-items-center gap-2">
                            ...
                            <ul class="nav nav-pills" id="aracTab" role="tablist">
                                ...
                                <li class="nav-item" role="presentation">
                                    <button class="nav-link <?php echo $activeTab === 'km' ? 'active' : ''; ?>"
                                        id="km-tab" data-bs-toggle="tab" data-bs-target="#kmContent" type="button"
                                        role="tab">
                            ...
                            <div class="d-flex flex-wrap gap-2 ms-auto">
                                ...
                                <div class="dropdown">
                                    ...
                                    <ul class="dropdown-menu">
                                        ...
                                        <li id="liExcelYakitYukle" style="display: none;"><a class="dropdown-item"
                                                href="#" data-bs-toggle="modal" data-bs-target="#excelModal">
                                    ...
                                    <div class="card border-0 shadow-sm h-100 bordro-summary-card evrak-stat-card <?php echo (!$filter) ? 'active' : ''; ?>" 
                                        ...
                                        <div class="card-body p-3">
                                            <div class="icon-label-container">
                                                ...
                                                <span class="text-muted small fw-bold" style="font-size: 0.65rem;">TÜMÜ</span>
                                            </div>
                                            <p class="text-muted mb-2 small fw-bold" style="letter-spacing: 0.5px; opacity: 0.7;">ARAÇ DURUMU</p>
                                            <div class="d-flex justify-content-between align-items-center mt-3">
                                                <span class="text-primary fw-bold">Toplam Araç</span>
                                                <h4 class="mb-0 fw-bold text-primary"><?php echo $aracStats->toplam_arac ?? 0; ?></h4>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="card border-0 shadow-sm h-100 bordro-summary-card evrak-stat-card <?php echo (strpos($filter, 'muayene') !== false) ? 'active' : ''; ?>" 
                                        ...
                                        <div class="card-body p-3">
                                            <div class="icon-label-container">
                                                ...
                                                <span class="text-muted small fw-bold" style="font-size: 0.65rem;">MUAYENE</span>
                                            </div>
                                            <p class="text-muted mb-2 small fw-bold" style="letter-spacing: 0.5px; opacity: 0.7;">MUAYENE DURUMU</p>
                                            <div class="d-flex flex-column gap-1">
                                                <a href="index.php?p=arac-takip/list&filter=muayene" class="d-flex justify-content-between align-items-center text-decoration-none">
                                                    <span class="text-danger fw-bold"><i class="bx bx-error-circle me-1"></i>Süresi Geçen</span>
                                                    <h5 class="mb-0 fw-bold text-danger"><?php echo $evrakStats->muayene_biten ?? 0; ?></h5>
                                                </a>
                                                <a href="index.php?p=arac-takip/list&filter=muayene_yaklasan" class="d-flex justify-content-between align-items-center text-decoration-none border-top pt-1">
                                                    <span class="text-warning fw-bold"><i class="bx bx-time-five me-1"></i>Yaklaşan (30 G)</span>
                                                    <h5 class="mb-0 fw-bold text-warning"><?php echo $evrakStats->muayene_yaklasan ?? 0; ?></h5>
                                                </a>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="card border-0 shadow-sm h-100 bordro-summary-card evrak-stat-card <?php echo (strpos($filter, 'sigorta') !== false) ? 'active' : ''; ?>" 
                                        ...
                                        <div class="card-body p-3">
                                            <div class="icon-label-container">
                                                ...
                                                <span class="text-muted small fw-bold" style="font-size: 0.65rem;">SİGORTA</span>
                                            </div>
                                            <p class="text-muted mb-2 small fw-bold" style="letter-spacing: 0.5px; opacity: 0.7;">SİGORTA DURUMU</p>
                                            <div class="d-flex flex-column gap-1">
                                                <a href="index.php?p=arac-takip/list&filter=sigorta" class="d-flex justify-content-between align-items-center text-decoration-none">
                                                    <span class="text-danger fw-bold"><i class="bx bx-error-circle me-1"></i>Süresi Geçen</span>
                                                    <h5 class="mb-0 fw-bold text-danger"><?php echo $evrakStats->sigorta_biten ?? 0; ?></h5>
                                                </a>
                                                <a href="index.php?p=arac-takip/list&filter=sigorta_yaklasan" class="d-flex justify-content-between align-items-center text-decoration-none border-top pt-1">
                                                    <span class="text-primary fw-bold"><i class="bx bx-time-five me-1"></i>Yaklaşan (30 G)</span>
                                                    <h5 class="mb-0 fw-bold text-primary"><?php echo $evrakStats->sigorta_yaklasan ?? 0; ?></h5>
                                                </a>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="card border-0 shadow-sm h-100 bordro-summary-card evrak-stat-card <?php echo (strpos($filter, 'kasko') !== false) ? 'active' : ''; ?>" 
                                        ...
                                        <div class="card-body p-3">
                                            <div class="icon-label-container">
                                                ...
                                                <span class="text-muted small fw-bold" style="font-size: 0.65rem;">KASKO</span>
                                            </div>
                                            <p class="text-muted mb-2 small fw-bold" style="letter-spacing: 0.5px; opacity: 0.7;">KASKO DURUMU</p>
                                            <div class="d-flex flex-column gap-1">
                                                <a href="index.php?p=arac-takip/list&filter=kasko" class="d-flex justify-content-between align-items-center text-decoration-none">
                                                    <span class="text-danger fw-bold"><i class="bx bx-error-circle me-1"></i>Süresi Geçen</span>
                                                    <h5 class="mb-0 fw-bold text-danger"><?php echo $evrakStats->kasko_biten ?? 0; ?></h5>
                                                </a>
                                                <a href="index.php?p=arac-takip/list&filter=kasko_yaklasan" class="d-flex justify-content-between align-items-center text-decoration-none border-top pt-1">
                                                    <span class="text-dark fw-bold"><i class="bx bx-time-five me-1"></i>Yaklaşan (30 G)</span>
                                                    <h5 class="mb-0 fw-bold text-dark"><?php echo $evrakStats->kasko_yaklasan ?? 0; ?></h5>
                                                </a>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <table id="aracTable" class="table table-hover table-bordered nowrap w-100">
                                        <thead class="table-light">
                                            <tr>
                                                ...
                                                <th style="width:9%" class="text-center">Muayene</th>
                                                <th style="width:9%" class="text-center">Sigorta</th>
                                                <th style="width:9%" class="text-center">Kasko</th>
